      ...
      <section class="px-[40px] pb-5 pt-[132px] sm:pt-[142px] lg:py-[20px]">
        ...
        <div class="w-full h-full p-10 mb-5 bg-white rounded-[8px] border-b-4 border-primary dark:bg-dark-primary dark:border-logo-color">
          <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 ">
            <div class="w-full flex flex-col justify-between gap-2 sm:justify-center">
              <h1 class="font-bold text-xl text-primary sm:text-3xl md:text-4xl lg:text-5xl dark:text-slate-200">Halo🌟I am</h1>
              <p class="font-bold text-2xl text-primary sm:text-4xl md:text-5xl lg:text-5xl dark:text-slate-200">Bintang <span class="text-logo-color">Santosa</span> </p>
              <p class="font-medium text-sm text-primary sm:text-xl lg:text-2xl dark:text-dark-fourth">I am a Frontend developer and Backend developer</p>
              <a href="https://wa.me/089630675999" target="_blank" class="self-start px-7 py-2 bg-primary text-white text-sm font-bold rounded-[8px] hover:bg-logo-color sm:px-10 sm:py-3 sm:text-lg dark:bg-logo-color dark:hover:bg-color-hover">Contact</a>
            </div>
        ...
        <!-- skills start -->
        <div class="w-full p-10 mb-5 bg-primary border-b-4 border-light-yellow rounded-[8px] grid grid-cols-1 gap-5 dark:bg-dark-five">
          <div class="">
